...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/fawa-io/fawa/gen/file/v1"
	http "net/http"
	strings "strings"
)
...
func NewFileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileServiceClient {
	...
	fileServiceMethods := v1.File_fawa_file_v1_file_proto.Services().ByName("FileService").Methods()
...
// ReceiveFile calls file.v1.FileService.ReceiveFile.
